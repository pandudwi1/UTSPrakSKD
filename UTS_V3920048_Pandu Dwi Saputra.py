...
def main():
    ...
    pesanDekripsi= "HUPFYVOQHNBWZLJIAFNLFXNMXSARNIWBPLVWCVPPTCBXLDCMIOPRHWEVJEGKUWYWJNGV"
    kunci = 'PANDUDWI'
    mode1 = 'enkripsi'
    mode2 = 'dekripsi' 
...
def main():
    ...
    text = 'HUPFYVOQHNBWZLJIAFNLFXNMXSARNIWBPLVWCVPPTCBXLDCMIOPRHWEVJEGKUWYWJNGV'#Pesan yang akan di enkripsi
    key = [3, 5]
    ...
    print('Ciphertext : ANYUZQVBASITCMGDFUSMUWSPWHFESDTIYMQTLQYYKLIWMOLPDVYEATRQGRXJNTZTGSXQ')
